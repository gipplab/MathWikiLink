...
class ArXivReader:
    ...
    the queried identifier. The queried identifier being an identifier requested via HTTP GET endpoint. Modified version
    of ArXivReader from AnnoMathTex.
    """
    def __init__(self):
...
def pp(dict_list, source):
    """
    post process: add QID from local file, remove optional description, identifier, wikimedia_link, link
    and fill to recommendations limit

    :param dict_list: dictionary list of recommendations from one source
...
def recommendations_dict_change_order(rd):
    """
    Change order of recommendations dict from Source --> Identifier --> Recommendations
    to Identifier --> Source --> Recommendations

    :param rd: recommendation dictionary with format 'Source --> Identifier --> Recommendations'
    :return rdf: recommendation dictionary with format 'Identifier --> Source --> Recommendations'
    """
